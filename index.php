							...
							<div class="col-md-4">
								...
								<ul class="arrow-feature">
									<li>
										...
										<p>Just enter the name of your local area above and we'll give you accurate results!</p>
									</li>
									<li>
										<h3>Check out some awesome photos!</h3>
										<p>We have a strong database that's updated daily by our userbase, promise!</p>
									</li>
									<li>
										<h3>Check out some live cameras!</h3>
										<p>We have live cameras from all over the world on this app, that you can access right here.</p>
									</li>
								</ul>
							</div>
							<div class="col-md-4">
